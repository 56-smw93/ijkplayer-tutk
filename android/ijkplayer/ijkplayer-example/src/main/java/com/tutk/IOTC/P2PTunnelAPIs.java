...
public class P2PTunnelAPIs {
	...
	* can't be connected anymore until anyone session release. */
	...
	public native static String P2PTunnel_Version_String();
	...
	@Deprecated public native int  P2PTunnelServer_Start(String UID);
	...
	@Deprecated public native int  P2PTunnelAgent_Connect(String UID, byte[] authData, int authDataLength, int[] errFromDeviceCB);
	@Deprecated public native int  P2PTunnelAgent_Connect_Parallel(String UID, int SID, byte[] authData, int authDataLength, int[] errFromDeviceCB);
	...
	public native int  P2PTunnelAgent_Attach_Connect_Stop(int SID, int CHID);
	...
	public native int  P2PTunnelServer_Start_Ex(String UID, tunnelServerAuthCB tunnelServerAuthFn, tunnelSessionInfoExCB sessionInfoExFn, Object userArg);
	public native int  P2PTunnelAgent_Connect_Ex(String UID, tunnelAgentAuthCB tunnelAgentAuthFn, Object userArg);
	public native int  P2PTunnelAgent_Connect_Parallel_Ex(String UID, int SID, tunnelAgentAuthCB tunnelAgentAuthFn, Object userArg);
	public native int  P2PTunnelAgent_Attach_Connect_Ex(int SID, int CHID, tunnelAgentAuthCB tunnelAgentAuthFn, Object userArg);

	public native int  P2PTunnelServer_Start_By_Nebula(long deviceCtx, tunnelSessionInfoExCB sessionInfoExFn, Object userArg);
	public native int  P2PTunnelAgent_Connect_By_Nebula(long clientCtx, String amToken, String realm, int timeoutMs);
	public native int  P2PTunnelAgent_Connect_Stop_By_Nebula(long clientCtx);
	...
	public interface tunnelAgentAuthCB {
        void onTunnelAgentAuth(String[] account, String[] password, Object userArg);
	}

	public interface tunnelSessionInfoExCB {
        void onTunnelSessionInfoExChanged(sP2PTunnelSessionInfoEx object, Object userArg);
	}
