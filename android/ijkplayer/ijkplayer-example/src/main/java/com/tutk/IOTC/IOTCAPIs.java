...
public class IOTCAPIs {
	...
	* Please see IOTCConnectionMode for possible modes. */
	...
	public native static int IOTC_Device_Login_By_Nebula(long device_ctx);
	public native static int IOTC_Device_Listen_By_Nebula(long device_ctx, int timeout_msec);
	public native static int IOTC_Client_Connect_By_Nebula(long client_ctx, String rent_am_token, String realm, int timeout_msec, NebulaAbort abort);
