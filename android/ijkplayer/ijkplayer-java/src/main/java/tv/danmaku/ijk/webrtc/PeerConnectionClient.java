...
import tv.danmaku.ijk.webrtc.AppRTCClient.SignalingParameters;
import tv.danmaku.ijk.webrtc.RtcEventLog;
...
public class PeerConnectionClient {
  ...
  public interface PeerConnectionEvents {
    ...
    /**
     * Callback fired once when peerconnection is created.
     */
    void onPeerConnectionCreated();

    /**
     * Callback fired when ice candidate gathering finish
     */
    void onIceGatheringChange(final PeerConnection.IceGatheringState newState);
  }
  ...
  public void getWebRTCApi(long[] api) {
    ...
    api[0] = factory.getWebRTCApiWebRTCApi();
  }
...
//    rtcConfig.enableDtlsSrtp = !peerConnectionParameters.loopback;
  ...
  public long getNativePeerConnecton() {
    return peerConnection.getNativePeerConnection();
  }
